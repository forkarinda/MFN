...
from .model import Seq2SeqModel, Seq2SeqEncoder, Seq2SeqDecoder, MMSeq2SeqModel
...
def build_model(args, all_dict):
    return ARCH_MODEL_REGISTRY[args.arch].build_model(args, all_dict)
...
def register_model(name):
    ...
    def register_model_cls(cls):
        ...
        if not (issubclass(cls, Seq2SeqModel) or issubclass(cls, MMSeq2SeqModel) or issubclass(cls, VideoSeq2SeqModel)):
